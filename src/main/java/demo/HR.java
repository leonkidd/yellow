...
/**
 * Demo 2:<br/>
 * TD-SheetN-Parser, TD-CellIntercepter, NONE Filler Demo
 * 
 * @author Leon Kidd
 * @version 1.00, 2014-2-14
 */
public class HR extends ACallback {
	private static HRTDCellIntercepter interceptor = null;
	...
	public static void main(String[] args) {
		...
		try {
			...
			TDParser parser = new SheetNParser("Sheet1"); // new
															// ExcelParserImpl();
			// Singleton ? TODO
			interceptor = new HRTDCellIntercepter(cellPoses);
